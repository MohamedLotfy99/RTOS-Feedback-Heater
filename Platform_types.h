...
#define pinNumbers 43

#define PORTA_Pin_NUmbers 8
#define PORTB_Pin_NUmbers 8
#define PORTC_Pin_NUmbers 8
#define PORTD_Pin_NUmbers 8
#define PORTE_Pin_NUmbers 6
#define PORTF_Pin_NUmbers 5

#define portNumbers 6
