...
// Control Port
#define CTRL_PORT GPIO_PORTF_DATA_R
#define CTRL_PORT_DIR GPIO_PORTF_DIR_R
#define CTRL_PORT_AFSEL GPIO_PORTF_AFSEL_R
#define CTRL_PORT_PCTL GPIO_PORTF_PCTL_R
#define CTRL_PORT_AMSEL GPIO_PORTF_AMSEL_R
#define CTRL_PORT_DEN GPIO_PORTF_DEN_R
#define RS 1
#define RW 2
#define E  3
#define DB7 7
